Files to be submitted:
    coreParser.py - Contains all new project 2 work.
    tokenizer.py - Contains the tokenizer.
    dictionary.py - Contains the tokenDict for the tokenizer.
    .env - Sets the DEBUG variable
...
This should work even if you run the program from the command line of a different directory.